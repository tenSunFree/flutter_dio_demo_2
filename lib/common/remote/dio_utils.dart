...
import 'package:flutter_dio_demo_2/common/base/base_entity.dart';
...
//      contentType: Headers.formUrlEncodedContentType, // 适用于post form表单提交
  ...
  Future<BaseEntity<T>> _request<T>(
    ...
    try {
      ...
      debugPrint('DioUtils, requestNetwork, data: $data');
  ...
  Future requestNetwork<T>(
    ...
    debugPrint('DioUtils, requestNetwork, url: $url');
    return _request<T>(
      method.value,
      url,
      data: params,
      ...
      debugPrint('DioUtils, requestNetwork, result: $result');
      if (result.code == 0) {
        if (onSuccess != null) {
          debugPrint('DioUtils, requestNetwork, result: $result, onSuccess');
  ...
  void _onError(int code, String msg, NetErrorCallback onError) {
    ...
    if (onError != null) onError(code, msg);
  }
}
